...
---
Site created with Jekyll and published through GH Pages. More information on theme manipulation and the inner-working of the project below this section.



### Todo Items:
- Check SEO / ADA compliance and standards
- Build MVP site
- Setup GH Page Publishing + Custom URL
- Production minification / obfuscation of scripts + styles
- Create Event layout
